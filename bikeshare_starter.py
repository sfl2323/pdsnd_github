...
def get_filters():
    """
    Asks user to specify a city, month, and day to analyze. Give them options so they know what to choose.
    ...
    while True:
        city = input('What city are you interested in: chicago, new york city or washington? ').lower()
